    ...
    $this->get(route('academics.academic-affairs'))
        ...
        ->assertInertia(fn (Assert $page) => $page
            ...
            ->has('academicAffairs.profile', fn (Assert $page) => $page
                ...
                ->where('image', '/images/administration/ovpaa/VPAA.webp')
                ->has('description', 2)
                ->has('biography', 2)
                ->has('priorities', 4)
                ->etc()
            ...
            ->has('academicAffairs.colleges', 9)
            ->where('academicAffairs.colleges.0.slug', 'college-of-accountancy')
            ->where('academicAffairs.colleges.0.title', 'College of Accountancy')
            ->where('academicAffairs.colleges.1.title', 'College of Agriculture and Forestry')
            ->where('academicAffairs.colleges.8.title', 'College of Teacher Education')
            ->has('academicAffairs.graduateProfessionalStudies', 3)
            ...
            ->where('academicAffairs.graduateProfessionalStudies.2.title', 'College of Medicine')
